/* =========================================================
   ...
   Solo se ejecuta una vez (si la BD local está vacía).
   ========================================================= */
...
const Seed = (() => {
  ...
  const seedPostulantes = () => ([
    { id: 'p1', usuarioId: 'u2', ofertaId: 'o1', nombre: 'Lucía Ramos',    email: 'lucia@example.com',  telefono: '+51 987 654 321', experiencia: '3 años en desarrollo backend', habilidades: 'Java, Spring Boot, SQL, React', estado: 'EN_EVALUACION',     puntaje: 85, cv: 'lucia_cv.pdf',  creadoEn: Date.now() - 86400000 * 4 },
    { id: 'p2', usuarioId: 'u3', ofertaId: 'o1', nombre: 'Carlos Mendoza', email: 'carlos@example.com', telefono: '+51 911 222 333', experiencia: '5 años en arquitectura',         habilidades: 'Java, Spring, Docker, AWS',     estado: 'APROBADO_TECNICO',   puntaje: 92, cv: 'carlos_cv.pdf', creadoEn: Date.now() - 86400000 * 3 },
    { id: 'p3', usuarioId: null, ofertaId: 'o2', nombre: 'María Torres',   email: 'maria@example.com',  telefono: '+51 933 555 777', experiencia: '4 años en diseño de producto',   habilidades: 'Figma, Sketch, UX research',    estado: 'POSTULADO',          puntaje: 0,  cv: 'maria_cv.pdf',  creadoEn: Date.now() - 86400000 * 1 },
    { id: 'p4', usuarioId: null, ofertaId: 'o1', nombre: 'Pedro Salinas',  email: 'pedro@example.com',  telefono: '+51 922 444 666', experiencia: '2 años en desarrollo web',       habilidades: 'JavaScript, React, Node',       estado: 'ENTREVISTA',         puntaje: 78, cv: 'pedro_cv.pdf',  creadoEn: Date.now() - 86400000 * 6 },
    { id: 'p5', usuarioId: null, ofertaId: 'o4', nombre: 'Andrea León',    email: 'andrea@example.com', telefono: '+51 944 888 111', experiencia: '6 años en ventas B2B',           habilidades: 'CRM, prospección, negociación', estado: 'EVALUACION_PSICOLOGICA', puntaje: 88, cv: 'andrea_cv.pdf', creadoEn: Date.now() - 86400000 * 9 },
    { id: 'p6', usuarioId: null, ofertaId: 'o3', nombre: 'Diego Álvarez',  email: 'diego@example.com',  telefono: '+51 955 777 222', experiencia: '3 años en marketing digital',    habilidades: 'Google Ads, SEO, GA4',          estado: 'ACEPTADO',           puntaje: 95, cv: 'diego_cv.pdf',  creadoEn: Date.now() - 86400000 * 14 },
    { id: 'p7', usuarioId: null, ofertaId: 'o2', nombre: 'Fiorella Rojas', email: 'fiorella@example.com',telefono:'+51 966 333 444', experiencia: '1 año en diseño',                habilidades: 'Figma, Illustrator',            estado: 'RECHAZADO',          puntaje: 52, cv: 'fiorella_cv.pdf',creadoEn: Date.now() - 86400000 * 7 }
  ]);

  // Series temporales para métricas (8 meses, similar al ejemplo del PDF)
  const seedMetricas = () => ({
    series: {
